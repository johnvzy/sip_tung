...
public class GlobalBroadcastReceiver extends BroadcastReceiver {
	...
	public void onReceive(Context context, Intent intent) {
		...
		String message = intent.getExtras().getString("BedId");
		Toast.makeText(context, "SIP 床號綁定至 : " + message, Toast.LENGTH_LONG).show();
		...
		//mConfigurationService.putString(NgnConfigurationEntry.IDENTITY_IMPU,message);
